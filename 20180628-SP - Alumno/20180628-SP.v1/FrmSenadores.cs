        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    serializarXML.Guardar(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Votacion.xml", votacion);
                    Dao<Votacion> guardarEnSql = new Dao<Votacion>();
                    guardarEnSql.Guardar(null, votacion);
